...
import { openLog, getLogs, getCount, focusSearch, decodeTitle } from './logs.js?v=7.4';
import { cycle, set, get as getTheme } from './theme.js?v=7.4';
import { toggle as toggleBgm, isPlaying } from './audio.js?v=7.4';
