...
import * as theme from './theme.js?v=7.8';
import * as i18n from './i18n.js?v=7.8';
import { init as initScene } from './scene.js?v=7.8';
import { init as initLogs } from './logs.js?v=7.8';
import { init as initApod } from './apod.js?v=7.8';
import { init as initAudio } from './audio.js?v=7.8';
import { init as initTerminal } from './terminal.js?v=7.8';
import { init as initTimeline } from './timeline.js?v=7.8';
